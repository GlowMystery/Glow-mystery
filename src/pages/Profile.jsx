...
const Profile = () => {
    ...
    const firstInitial = formData.name
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="row mb-4 align-items-center text-center text-md-start">
                                        ...
                                        <div className="col-12 col-md">
                                            ...
                                            <label className="form-label text-gold">
                                                Profile Image
                                            </label>

                                            <input
                                                className="form-control text-light bg-transparent border-secondary w-100"
                                                type="file"
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                type="text"
                                                className="form-control text-light bg-transparent border-secondary"
                                                required
                                                value={formData.name}
                                                onChange={e =>
                                                    setFormData({
